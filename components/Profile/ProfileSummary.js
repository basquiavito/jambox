...
<Label label="Career High"/>
 ...
 <Title title={this.props.careerHigh1Title}/>
 <Dekk dekk={this.props.careerHigh1Dekk}/>
 <Authordate  author={this.props.careerHigh1Author} date={this.props.careerHigh1Date} />
</div><br/>
</div>
)
 ...
 <Play image={this.props.imageCollege} title="College" name="Growth" >
   <button
    ...
    <div>
      ...
      <Title title={this.props.videoIdTitle}/>
