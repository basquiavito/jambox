    ...
    return(
        ...
        <div className="footerMobileSection">
            ...
            <div className="footerTitle"><span className="rightSide">hooper</span><span className="os">os </span>  </div>
                ...
                <p className="aboutText">The young person’s guide to mastering the world of basketball. hooperOS covers the latest in basketball news, stats, highlights, notation, learning, rumors,  and entertainment.</p>
    </div>
...
<a height="22" target="_blank" rel="noopener" href="https://www.facebook.com/hooperosNBA/" className="socialLinks">
...
<a height="22" target="_blank" rel="noopener" href="https://twitter.com/hooperos_NBA" className="socialLinks">
...
<a height="22" target="_blank" rel="noopener" href="https://www.instagram.com/hooperos_nba/" className="socialLinks">
...
<a height="19" target="_blank" rel="noopener" href="https://www.youtube.com/channel/UC4ep3OiokVVaVCTFh8AG7Hw?view_as=subscriber" className="socialLinks">
...
.os {
    ...
    font-size: 34px;
        ...
        .siteFooterAbout {
    --type-token-name: foundation.meta-primary;
    line-height: 1.43em;
