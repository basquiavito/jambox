...
export default function Footer(){
    return(
        <><br/>
        <div className="footerMobileSection">
            <div className="pageGridCentro">
            <div className="pageFooterSlogan">
 <h1 className="socialSlogan">Hooperos es la coleccion mas grande de jugadas de la NBA en latinoamerica. Brindamos entretenimiento y educacion sobre el Baloncesto. </h1>
<div className="socialLinkContainer">
<a height="22" target="_blank" rel="noopener" href="https://www.facebook.com/hoopscript/" className="socialLinks">
<svg viewBox="0 0 9.95 20"><path d="M8.09 3.81c-1.4 0-1.58.84-1.58 1.67v1.3h3.35L9.49 11h-3v9H2.33v-9H0V6.88h2.42V3.81C2.42 1.3 3.81 0 6.6 0H10v3.81z"></path></svg></a>
<a height="22" target="_blank" rel="noopener" href="https://twitter.com/hoopscript" className="socialLinks">
<svg viewBox="0 0 20 16.43"><path d="M20 1.89l-2.3 2.16v.68a12.28 12.28 0 0 1-3.65 8.92c-5 5.13-13.1 1.76-14.05.81 0 0 3.78.14 5.81-1.76A4.15 4.15 0 0 1 2.3 9.86h2S.81 9.05.81 5.81A11 11 0 0 0 3 6.35S-.14 4.05 1.49.95a11.73 11.73 0 0 0 8.37 4.19A3.69 3.69 0 0 1 13.51 0a3.19 3.19 0 0 1 2.57 1.08 12.53 12.53 0 0 0 3.24-.81l-1.75 1.89A10.46 10.46 0 0 0 20 1.89z"></path></svg></a>
<a height="22" target="_blank" rel="noopener" href="https://www.instagram.com/hoopscript/" className="socialLinks">
...
<a height="19" target="_blank" rel="noopener" href="https://www.youtube.com/hoopscript" className="socialLinks">
<svg viewBox="0 0 20.01 14.07"><path d="M19.81 3A4.32 4.32 0 0 0 19 1a2.86 2.86 0 0 0-2-.8C14.21 0 10 0 10 0S5.8 0 3 .2A2.87 2.87 0 0 0 1 1a4.32 4.32 0 0 0-.8 2S0 4.51 0 6.06V8a30 30 0 0 0 .2 3 4.33 4.33 0 0 0 .8 2 3.39 3.39 0 0 0 2.2.85c1.46.14 5.9.19 6.68.2h.4c1 0 4.35 0 6.72-.21a2.87 2.87 0 0 0 2-.84 4.32 4.32 0 0 0 .8-2 30.31 30.31 0 0 0 .2-3.21V6.28A30.31 30.31 0 0 0 19.81 3zM7.94 9.63V4l5.41 2.82z"></path></svg></a>
</div></div>
<div className="LinkSection">
<Link href="/about"   ><a className="footerPageLinks">Sobre Nosotros</a></Link>
<Link href="/about"  ><a rel="noopener" className="footerPageLinks">Prensa</a></Link>
...
<a className="finePrint">Terms of use</a>
        </Link>
    </div>
    ...
    <div className="lowestLevel">
        <Link href="/static/terms" >
        <a className="finePrint">© 2020 Hoopscript Media Group Inc.</a>
        </Link>
    </div>   
