...
function AirSummary({ code, videoIdA, videoIdB, twitterToken, title, author, label, videoId, dekk, contentA, date, label1, title1, dekk1,   }) {
...
<div className="editorialContainer">
 ...
 <LazyLoad>
 <Youtubehooks videoIdA={videoIdA} videoIdB={videoIdB} />
 </LazyLoad>
